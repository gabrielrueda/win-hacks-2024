...
i = 1
for box in boxes:
    box[0] = ((int)((box[0][0] / 1920) * 445), (int)((box[0][1] / 1080) * 219))
    box[1] = ((int)((box[1][0] / 1920) * 445), (int)((box[1][1] / 1080) * 219))
    box[2] = ((int)((box[2][0] / 1920) * 445), (int)((box[2][1] / 1080) * 219))
    box[3] = ((int)((box[3][0] / 1920) * 445), (int)((box[3][1] / 1080) * 219))
